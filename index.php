...
<section class="collection">
    ...
    <div class="collection-header">
        <div class="collection-title-group">
            <span class="collection-label">MUESTRA</span>
            <h2 class="collection-title">LIBROS MÁS INTERESANTES</h2>
        </div>
    ...
    <div class="grid">
        ...
        <div class="card">
            <div class="card-image-wrapper">
                <img src="assets/images/books/civilizaciones-perdidas.jpg" alt="Civilizaciones Perdidas" loading="lazy">
                <div class="card-overlay">
                    <span class="tag">HISTORIA</span>
                    <h3>CIVILIZACIONES PERDIDAS</h3>
        ...
        <div class="card">
            <div class="card-image-wrapper">
                <img src="assets/images/books/etica-a-nicomaco.jpg" alt="Ética a Nicómaco" loading="lazy">
                <div class="card-overlay">
